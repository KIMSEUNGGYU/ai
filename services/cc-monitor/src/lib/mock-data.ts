...
export const mockEvents: StoredEvent[] = [
  ...
  },
  {
    ...
    project_path: "/projects/web-app",
    tool_name: "Skill",
    tool_input_summary: "skill: brainstorming",
    model: "claude-sonnet-4-20250514",
    prompt_text: null,
    permission_mode: "default",
    tool_use_id: "tu-6",
  ...
  },
  {
    ...
    tool_input_summary: "select:Read,Edit,Write",
    model: "claude-sonnet-4-20250514",
    prompt_text: null,
    permission_mode: "default",
    tool_use_id: "tu-8",
  ...
  },
  {
    ...
    tool_input_summary: "MCP: serena/find_symbol",
    model: "claude-sonnet-4-20250514",
    prompt_text: null,
    permission_mode: "default",
    tool_use_id: "tu-9",
...
export const mockToolUsageStats: ToolUsageStat[] = [
  ...
  { tool_name: "ToolSearch", count: 24, percentage: 5 },
  { tool_name: "Skill", count: 18, percentage: 4 },
  { tool_name: "AskUserQuestion", count: 12, percentage: 2 },
